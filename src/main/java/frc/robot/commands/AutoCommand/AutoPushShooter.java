...
public class AutoPushShooter extends Command {
  /** Creates a new AutoPushShooter. */
  private final SwerveSubsystem m_SwerveSubsystem;
  private final IntakeSubsystem m_IntakeSubsystem;
  private final ShooterSubsystem m_ShooterSubsystem;
  private final ConveyorSubsystem m_ConveyorSubsystem;
  private boolean ifIndexer;
  public AutoPushShooter(SwerveSubsystem swerveSubsystem, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem, ConveyorSubsystem conveyorSubsystem) {
    ...
    ifIndexer = false;
    addRequirements(m_ConveyorSubsystem, m_IntakeSubsystem, m_ShooterSubsystem, m_SwerveSubsystem);
  }
